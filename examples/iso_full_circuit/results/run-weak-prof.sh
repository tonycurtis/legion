...
${HOME}/local/bin/gasnetrun_ibv -n 16  ./ckt_sim -npp 250000 -wpp 500000 -p 16 -l 20  -ll:cpu 5 -ll:zsize 4192 -ll:fsize 4192 -ll:gpu 1 -ll:dma 5 -ll:ahandlers 5 -ll:rsize 1920 -ll:gsize 0 -hl:prof 16 -level legion_prof=2
echo "running 32 nodes" 
${HOME}/local/bin/gasnetrun_ibv -n 32  ./ckt_sim -npp 250000 -wpp 500000 -p 32 -l 20  -ll:cpu 5 -ll:zsize 4192 -ll:fsize 4192 -ll:gpu 1 -ll:dma 5 -ll:ahandlers 5 -ll:rsize 1920 -ll:gsize 0 -hl:prof 16 -level legion_prof=2
