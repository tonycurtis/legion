...
${HOME}/local/bin/gasnetrun_ibv -n 2  ./ckt_sim -npp 500000 -wpp 1000000 -p 2 -l 5  -ll:cpu 5 -ll:zsize 2048 -ll:fsize 4192 -ll:gpu 1 -ll:dma 5 -ll:ahandlers 5 -ll:rsize 1920 -ll:gsize 0
echo "running 4 nodes"  
${HOME}/local/bin/gasnetrun_ibv -n 4  ./ckt_sim -npp 500000 -wpp 1000000 -p 4 -l 5  -ll:cpu 5 -ll:zsize 2048 -ll:fsize 4192 -ll:gpu 1 -ll:dma 5 -ll:ahandlers 5 -ll:rsize 1920  -ll:gsize 0 
echo "running 8 nodes" 
${HOME}/local/bin/gasnetrun_ibv -n 8  ./ckt_sim -npp 500000 -wpp 1000000 -p 8 -l 5  -ll:cpu 5 -ll:zsize 2048 -ll:fsize 4192 -ll:gpu 1 -ll:dma 5 -ll:ahandlers 5 -ll:rsize 1920 -ll:gsize 0 
echo "running 16 nodes" 
${HOME}/local/bin/gasnetrun_ibv -n 16  ./ckt_sim -npp 500000 -wpp 1000000 -p 16 -l 5  -ll:cpu 5 -ll:zsize 2048 -ll:fsize 4192 -ll:gpu 1 -ll:dma 5 -ll:ahandlers 5 -ll:rsize 1920 -ll:gsize 0 
